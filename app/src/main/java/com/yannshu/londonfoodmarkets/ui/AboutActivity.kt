...
class AboutActivity : BaseActivity() {
    ...
    private fun initStaticLayouts() {
        ...
        privacyPolicyLayout.setOnClickListener { safeStartActivityWithViewActionAndErrorDisplay(getString(R.string.privacy_policy_website), rootLayout) }
    }
